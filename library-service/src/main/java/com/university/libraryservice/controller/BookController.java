...
public class BookController {
    ...
    public ResponseEntity<ApiResponse<BookDto>> addBook(@Valid @RequestBody BookCreateRequestDto dto, @AuthenticationPrincipal Jwt jwt) {
    ...
    public ResponseEntity<ApiResponse<BookDto>> updateBook(@PathVariable Long id, @Valid @RequestBody BookUpdateRequestDto updateDto, @AuthenticationPrincipal Jwt jwt) {
        String currentUserName = jwt.getClaimAsString("sub");
        String adminEmail = jwt.getClaimAsString("email");
    ...
    public ResponseEntity<ApiResponse<BookDto>> patchBook(@PathVariable Long id, @Valid @RequestBody BookPatchRequestDto patchDto, @AuthenticationPrincipal Jwt jwt) {
        String currentUserName = jwt.getClaimAsString("sub");
        String adminEmail = jwt.getClaimAsString("email");
    ...
    public ResponseEntity<ApiResponse<Void>> deleteBook(@PathVariable Long id, @AuthenticationPrincipal Jwt jwt) {
        String currentUserName = jwt.getClaimAsString("sub");
        String adminEmail = jwt.getClaimAsString("email");
